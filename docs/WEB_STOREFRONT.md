...
| Page | URL | Purpose |
|------|-----|---------|
| **Store / landing** | https://www.pushthrugame.com/store.html | Share this for marketing, platforms, “download” |
| **Play** | https://www.pushthrugame.com/ | Actual game + friend/group invite deep links |
| **Web login** | https://www.pushthrugame.com/?tab=style | Opens Settings (email sign-in) |
...
```text
https://www.pushthrugame.com/assets/og-image.png
```
